...
def train_an_epoch(config, base, loaders, epoch):
    ...
    for _ in range(500):
        ...
        # base��Ӧ���������������Щ��return��ʱ���ã����γ���tuple�������ͣ�Ԫ�飩
        # (feature_vector_list, gcned_feature_vector_list),
        ...
        ### graph matching loss
        s_gt = torch.eye(14).unsqueeze(0).repeat([s_p.shape[0], 1, 1]).detach().to(base.device) #[16,14,14]
        pp_loss = base.permutation_loss(s_p, s_gt)  #s_p,s_n,s_gt����[16,14,14]
