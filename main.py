...
#改变图神经网络连接的步骤
#1. main.py --branch_num
#2. base.py --self.linked_edges
#3. default.py --_C.MODEL.JOINTS_GROUPS
#4. F:\python_model\HOReID\core\models\model_graph_matching\__init__.py   Class-GMNet,  Class-Verificator
...
--output_path .\\results\\0528-HRNet_layer

测试：
--mode test
--resume_test_path F:\python_model\HOReID\HOReID\\results\\0428resnet34with-no-grad\models
--resume_test_epoch 199
--duke_path ./Occluded-DukeMTMC-Dataset/Occluded_Duke
--output_path ./results//0428resnet34with-no-grad
...
可视化
--mode visualize
--resume_visualize_path F:\\python_model\\HOReID\\HOReID\\results\\models
--duke_path ./Occluded-DukeMTMC-Dataset/Occluded_Duke
"""
...
if __name__ == '__main__':
	...
	# model configuration
	parser.add_argument('--pid_num', type=int, default=1500, help='702 DukeMTMC-reID')
	...
	parser.add_argument('--resume_visualize_path', type=str, default='F:\\python_model\\HOReID\\results\\visualization\\market', help=' for no resuming')
	parser.add_argument('--resume_visualize_epoch', type=int, default=21, help='0 for no resuming')
