...
#HHRNet
# POSE_HIGH_RESOLUTION_NET.DECONV = CN()
# POSE_HIGH_RESOLUTION_NET.DECONV.NUM_DCONVS = 1
# POSE_HIGH_RESOLUTION_NET.DECONV.NUM_CHANNELS = [32, 32]
# POSE_HIGH_RESOLUTION_NET.DECONV.NUM_BASIC_BLOCKS = 4
# POSE_HIGH_RESOLUTION_NET.DECONV.KERNEL_SIZE = [4, 4]
# POSE_HIGH_RESOLUTION_NET.DECONV.CAT_OUTPUT = [True, True]
